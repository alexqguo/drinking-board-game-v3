...
//   type: RuleTypeEnum.DisplayRule;
// };

// /** SCHEMA_EQUIVALENT: Replace with @repo/schemas */
// export type MoveRule = BaseRule & {
//   type: RuleTypeEnum.MoveRule;
...
//   type: RuleTypeEnum.ChallengeRule;
// };

// /** SCHEMA_EQUIVALENT: Replace with @repo/schemas */
// export type GroupActionRule = BaseRule & {
//   type: RuleTypeEnum.GroupActionRule;
// } & AtLeastOneOf<{
//     diceRolls?: DiceRollSchema;
//     itemIds?: string[];
//   }>;
...
//   type: RuleTypeEnum.ItemBasedRule;
